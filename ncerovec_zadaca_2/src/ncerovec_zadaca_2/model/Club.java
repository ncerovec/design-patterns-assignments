 ...
 */
package ncerovec_zadaca_2.model;
...
import ncerovec_zadaca_2.notifications.NotificationSubject;
import ncerovec_zadaca_2.table.Table;
import ncerovec_zadaca_2.table.TableDecoratorFooter;
import ncerovec_zadaca_2.table.TableDecoratorHeader;
import ncerovec_zadaca_2.table.TableDivers;
import ncerovec_zadaca_2.table.TableDives;
import ncerovec_zadaca_2.table.TableDivingStats;
...
public class Club implements NotificationSubject
{
    ...
    {
        TableDivingStats tableStats = new TableDivingStats(this.getDives(), 20);
    ...
    {
        TableDivers tableDivers = new TableDivers(this.getDivers(), 30, details);
    ...
    {
        TableDives tableDives = new TableDives(this.getDives(), 20, details);
