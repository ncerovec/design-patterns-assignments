...
public class TableDivingStats extends TableBasic
{
    ...
    public TableDivingStats(List<Dive> dives, int cellSize)
    {
    ...
    public List<String[]> getRows()
    {
        ...
        String[] columnValues = {Integer.toString(numDives), Float.toString(sumDepth/numDives), Integer.toString(diversHRS.size()), Integer.toString(diversSSI.size()), Integer.toString(diversNAUI.size()), Integer.toString(diversCMAS.size()), Integer.toString(diversBSAC.size())};
