...
import ncerovec_zadaca_4.helper.AppHelper.LimitedQueue;
...
public abstract class ConsoleView implements View
{
    ...
    public void previousConsole()
    {
        if(this.currentPage > 1) this.currentPage--;
        printBuffer(this.currentPage);
    }
    
    public void nextConsole()
    {
    ...
    {
        //for(String row : bufferPage) { System.out.println(row); } //DEBUG
