...
import ncerovec_zadaca_4.mvc.equipment.EquipmentController;
import ncerovec_zadaca_4.mvc.equipment.EquipmentModel;
...
public class EquipmentContext
{
    ...
    public static int maxLoanDays = 0;
    ...
    public List<EquipmentCategory> readEquipment(String equipmentFile)
    {
        ...
        List<EquipmentCategory> equipmentStock = Club.getInstance().getEquipmentStock();
        ...
        {           
            ...
            while((equipmentLine = inEquipment.readLine()) != null)
            {
                ...
                {   
                    ...
                    EquipmentPart newEquipment = new EquipmentPart(equipmentId, equipmentName, equipmentQty);                    
    ...
    public static void showEquipmentView(Dive contextDive)
    {
        EquipmentModel equipmentModel = new EquipmentModel(contextDive);
