...
import ncerovec_zadaca_4.algorithm.comparison.AlgorithmComparator;
...
public class DiveManager    //DiveSelector
{
    ...
    */
    ...
    public void createDive(String date, String time, int maxDepth, int numDiver, float tempWater, boolean nightDive, int numCameras)    //standard+qualified dive
    {
        diveBuilder.createNewDive();
        diveBuilder.buildDatetime(date, time);
        diveBuilder.buildMaxDepth(maxDepth);
        ...
        DivesContext.showDiveView(this.diveBuilder.getDive());  //print created dive
    }
