...
public class Dive
{
    ...
    private Map<Diver, List<EquipmentObject>> equipmentAssignments = null;    
    ...
    public Map<Diver, List<EquipmentObject>> getEquipmentAssignments() { return equipmentAssignments; }
    public void setEquipmentAssignments(Map<Diver, List<EquipmentObject>> equipmentAssignments) { this.equipmentAssignments = equipmentAssignments; }
    ...
    */
    ...
    public List<EquipmentObject> getAvailableEquipment(String categoryId)
    {
        List<EquipmentObject> availableEquipment = new ArrayList();
        
        for(EquipmentObject equipment : this.getEquipmentAssignments().get(null))   //get unassigned equipment
        {
