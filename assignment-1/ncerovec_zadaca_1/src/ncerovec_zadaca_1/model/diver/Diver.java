...
import ncerovec_zadaca_1.model.agency.Agency;
...
public abstract class Diver
{
    ...
    */
    ...
    {
        String levelString = this.getLvl() + "->" + this.getLevel().getLabel() + ":" + ((this.getLevel().getTitle() != null) ? this.getLevel().getTitle() : "Nema tečaj");
        return this.getName() + " (" + this.getAgency() + " / " + levelString + " / " + this.getBirthYear() + ")";
    }
}
